...
PROJECT_INSTRUCTION = (
    ...
    "application 'vscode', 'terminal', or 'workspace'. 'workspace' means opening "
    "both VS Code and Windows Terminal in that same registered project using one "
    "visible confirmation. If they say 'open my development workspace', use "
    "'workspace'. If they just say 'open the project' without indicating a target, "
    "ask whether they want VS Code, Windows Terminal, or both. Never invent names "
    "or paths. "
...
BRIEFING_INSTRUCTION = (
    ...
    "all assignments, or create reminders. The calendar feed may omit assignments. "
    "Clearly distinguish a verified "
